  ...
  <div>
    ...
    <div class="row justify-between">
      <div class="col-3">
        ...
        <div class="row items-center mb-8">
          <img class="mr-12" src="/icons/no-smoker.svg" />
          <div>Non fumeurs</div>
        </div>

        <div class="row items-center mb-8">
          <img class="mr-12" src="/icons/no-party.svg" />
          <div>Pas de fête ni de soirée</div>
        </div>

        <div class="row items-center mb-24">
          <img class="mr-12" src="/icons/yes-pet.svg" />
      ...
      <div class="col-3">
        <div class="bold mb-12">Conditions d’annulation</div>
